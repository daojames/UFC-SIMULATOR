...
public class BrawlAlgorithm {

	public static String player2_1(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (Weight.Player.strk * 6) + (Weight.Player.spd * 1) + (Weight.Player.iq * 1) + (Weight.Player.luck * 1)) - 1 - (FightScreen.opIqDbl * 3);
		...
		if (randomSteady1 <= chance) {
			...
			if (FightScreen.hitpoints2 <= damage) {
				...
				if (damage >= 20) {
					...
					double retStam = (damage / FightScreen.max2) * 100;
					String ret = (Weight.Player.last + " TKOs " + FightScreen.opLast + " WITH A FLURRY OF STRIKES, DEALING " + FightScreen.df1.format(retStam) + "% DAMAGE");
					return ret;
				}
			}
			else {
				if (damage >= 30) {
					...
					double retStam = (damage / FightScreen.max2) * 100;
					String ret = (Weight.Player.last + " THROWS A FLURRY OF STRIKES, DEALING " + FightScreen.df1.format(retStam) + "% DAMAGE");
					return ret;
				}
			}
		}
			...
			String ret = (Weight.Player.last + " THROWS A FLURRY OF STRIKES, BUT MISSES");
			return ret;
		}
	}
	
	public static String player2_2(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (Weight.Player.strk * 6) + (Weight.Player.spd * 1) + (Weight.Player.iq * 1) + (Weight.Player.luck * 1)) - 1 - 15;
		...
		if (randomSteady1 <= chance) {
			...
			String ret = (Weight.Player.last + " THROWS A FLURRY OF STRIKES, BUT IS BLOCKED");
			return ret;
		}
	}
	
	public static String player2_3(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (Weight.Player.strk * 6) + (Weight.Player.spd * 1) + (Weight.Player.iq * 1) + (Weight.Player.luck * 1)) - 1;
	...
	public static String op2_1(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (FightScreen.opStrkDbl * 6) + (FightScreen.opSpdDbl * 1) + (FightScreen.opIqDbl * 1) + (FightScreen.opLuckDbl * 1)) - 1 - (Weight.Player.iq * 3);
		...
		if (randomSteady1 <= chance) {
			...
			if (FightScreen.hitpoints1 <= damage) {
				...
				if (damage >= 20) {
					...
					double retStam = (damage / FightScreen.max1) * 100;
					String ret = (FightScreen.opLast + " TKOs " + Weight.Player.last + " WITH A FLURRY OF STRIKES, DEALING " + FightScreen.df1.format(retStam) + "% DAMAGE");
					return ret;
				}
			}
			else {
				if (damage >= 30) {
					...
					double retStam = (damage / FightScreen.max1) * 100;
					String ret = (FightScreen.opLast + " THROWS A FLURRY OF STRIKES, DEALING " + FightScreen.df1.format(retStam) + "% DAMAGE");
					return ret;
				}
			}
		}
			...
			String ret = (FightScreen.opLast + " THROWS A FLURRY OF STRIKES, BUT MISSES");
			return ret;
		}
	}
	
	public static String op2_2(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (FightScreen.opStrkDbl * 6) + (FightScreen.opSpdDbl * 1) + (FightScreen.opIqDbl * 1) + (FightScreen.opLuckDbl * 1)) - 1 - 15;
		...
		if (randomSteady1 <= chance) {
			...
			String ret = (FightScreen.opLast + " THROWS A FLURRY OF STRIKES, BUT IS BLOCKED");
			return ret;
		}
	}
	
	public static String op2_3(int randomSteady, double randomDamage) {
		double randomSteady1 = (double) randomSteady;
		
		double chance = (10 + (FightScreen.opStrkDbl * 6) + (FightScreen.opSpdDbl * 1) + (FightScreen.opIqDbl * 1) + (FightScreen.opLuckDbl * 1)) - 1;
